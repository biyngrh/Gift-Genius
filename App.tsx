...
import { Gift, Sparkles, History as HistoryIcon, Loader2, RefreshCcw, Moon, Sun, Camera, X, ChevronDown } from 'lucide-react';
                ...
                <div className="w-full md:w-1/3 shrink-0">
                  ...
                  >
                    {selectedImage ? (
                      ...
                      <>
                        <div className="bg-white dark:bg-white/10 p-3 rounded-full mb-3 shadow-sm group-hover/image:scale-110 transition-transform">
            ...
            <div className="animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pb-10">
                {recommendations.map((gift, index) => (
                  <GiftCard key={index} gift={gift} index={index} language={language} />
                ))}
              </div>
            </div>
          )}
